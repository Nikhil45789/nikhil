...
//remove toast in small screen
var w = document.documentElement.clientWidth || window.innerWidth;
if (w <= 620) {
  $(".toast").addClass("toasti");
...
function setTimeout1() {
  const timeDisplay1 = document.getElementById("time11");
  const millis1 = Date.now() - start1;
  var sec2=0;
  var sec3=0;

  var sec1=Math.floor(millis1 / 1000);
  if (sec1>60) {
    sec2=Math.floor(sec1/60);
    sec3=sec1-(sec2*60);
    minutes=" minutes";
    colon=":"
  } else {
  ...
  timeDisplay1.textContent ="You have wasted "+ sec2+colon+sec3+minutes+" on my Website";

}
setInterval(setTimeout1, 100);
